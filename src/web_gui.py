...
<body>
    <div class="container">
        ...
        <div class="add-section">
            ...
            <div class="checkbox-group">
                ...
                <label><input type="checkbox" id="unsubscribe-emails" {"checked" if self.preferences.get('unsubscribe_emails', False) else ""}> 📧 Unsubscribe from emails before deleting</label>
            </div>
        </div>
    ...
    <script>
        ...
        function saveAndStart() {{
            const settings = {{
                ...
                unsubscribe_emails: document.getElementById('unsubscribe-emails').checked
            }};
    ...
    def handle_save_settings(self):
        ...
        try:
            ...
            self.preferences['unsubscribe_emails'] = settings.get('unsubscribe_emails', False)
